...
bool R_PG_Timer_Set_MTU_U0_C0(void)
{
	...
	create_params.data5 = PDL_MTU3_BUFFER_AC_ENABLE | PDL_MTU3_BUFFER_BD_ENABLE | PDL_MTU3_BUFFER_AC_CM_A | PDL_MTU3_BUFFER_BD_CM_B;
	create_params.data6 = PDL_MTU3_A_OC_LOW_CM_HIGH | PDL_MTU3_B_OC_LOW;
	create_params.data10 = 24999;
	create_params.data11 = 2200;
	create_params.data12 = 24999;
	create_params.data13 = 2200;
