...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_Set_C0(void)
*
* Function Name: R_PG_RSPI_Set_C0
*
...
bool R_PG_RSPI_Set_C0(void)
{
	return R_SPI_Create(
		0,
		PDL_SCI_MODE_SYNC_MASTER | PDL_SPI_FULL_DUPLEX | PDL_SPI_PIN_A | PDL_SPI_PIN_RSPCK_ENABLE | PDL_SPI_PIN_MOSI_ENABLE | PDL_SPI_PIN_MISO_ENABLE | PDL_SPI_PIN_SSL0_DISABLE | PDL_SPI_PIN_SSL1_DISABLE | PDL_SPI_PIN_SSL2_DISABLE | PDL_SPI_PIN_SSL3_DISABLE | PDL_SPI_PIN_MOSI_IDLE_LAST,
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_SetCommand_C0(void)
*
* Function Name: R_PG_RSPI_SetCommand_C0
*
...
bool R_PG_RSPI_SetCommand_C0(void)
{
	...
	res = R_SPI_Command(
		0,
		0,
		PDL_SPI_CLOCK_MODE_3 | PDL_SPI_DIV_1 | PDL_SPI_ASSERT_SSL0 | PDL_SPI_SSL_NEGATE | PDL_SPI_LENGTH_8 | PDL_SPI_MSB_FIRST,
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_StartTransfer_C0(uint32_t * tx_start, uint32_t * rx_start, uint16_t sequence_loop_count)
*
* Function Name: R_PG_RSPI_StartTransfer_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_GetStatus_C0(bool * idle, bool * receive_full, bool * transmit_empty)
*
* Function Name: R_PG_RSPI_GetStatus_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_GetError_C0(bool * over_run, bool * mode_falt, bool * parity_error)
*
* Function Name: R_PG_RSPI_GetError_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_GetCommandStatus_C0(uint8_t * current_command, uint8_t * error_command)
*
* Function Name: R_PG_RSPI_GetCommandStatus_C0
*
...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_StopModule_C0(void)
*
* Function Name: R_PG_RSPI_StopModule_C0
*
